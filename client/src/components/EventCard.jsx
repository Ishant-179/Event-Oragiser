// // src/components/NewEventCard.jsx
...
//     const handleClick = () => {
//         // Here, we'll navigate to the event detail page
//         // You can add your authentication check here if needed
//         navigate(`/events/${event._id}`);
//     };

//     const formattedDate = event.startDate ? new Date(event.startDate).toLocaleDateString('en-US', { day: 'numeric', month: 'short', year: 'numeric' }) : 'N/A';
//     const formattedTime = event.startTime ? event.startTime : 'N/A';
//     const location = event.medium === 'In Person' ? event.location : 'Online';
//     const price = event.price === 'Free' ? 'Free' : `$${event.price}`;

//     return (
//         <div 
//             onClick={handleClick}
//             className="group relative bg-gray-900 border border-gray-700 rounded-2xl overflow-hidden cursor-pointer shadow-lg transform transition-all duration-300 hover:shadow-2xl hover:-translate-y-2"
//         >
...
//             navigate(`/events/${event._id}`);
//         } else {
//             navigate('/login', { state: { redirectTo: `/events/${event._id}` } });
//         }
//     };
...
//         <GlowCard 
//         className='w-full cursor-pointer transform transition-all duration-300 hover:-translate-y-2 h-[63vh]'
//         glowColor='green'
//         onClick={handleClick}
//         >

//         {/* // <div
//         //     className="bg-gray-900 border border-gray-700 rounded-2xl overflow-hidden cursor-pointer shadow-lg transform transition-all duration-300 hover:shadow-2xl hover:-translate-y-2"
//         //     onClick={handleClick}
//         // >  */}
//             <div className="relative w-full h-56 overflow-hidden">
//                 <img
