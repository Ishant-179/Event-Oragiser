...
const HomePage = () => {
    ...
    return (
        <div className="h-full">
           <div className="relative min-h-[500px] flex items-center justify-center overflow-hidden bg-transparent">
  <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center relative z-10 p-4 sm:p-6">
    <div className="text-center md:text-left animate-fade-in-left">
      ...
      <p className="text-base sm:text-lg text-gray-300 mb-6 sm:mb-8 max-w-lg mx-auto md:mx-0 leading-relaxed">
        Book and learn helpful tips from 3,168+ mentors in world-class companies with our global community.
      </p>
      <button
        onClick={() => navigate('/events')}
        className="w-full sm:w-auto px-8 py-3 sm:px-10 sm:py-4 bg-green-600 text-white rounded-full font-bold text-base sm:text-lg shadow-xl hover:bg-green-700 transition duration-300 transform hover:scale-105 focus:outline-none focus:ring-4 focus:ring-green-500 focus:ring-opacity-50"
      >
        Explore Now
      </button>
    </div>
